...
- [21.10 ~ 22.09][BackEnd]GS 내부 대시보드 개발/운영 (통계 및 차트,공통 API 개발, 개발/운영계 구축 및 배포 담당)
- [20.11 ~ 21.09][BackEnd]GS 어바웃펫 개발/운영(회원,포인트,공통 API 및 배포 담당)
- [20.03 ~ 20.11][BackEnd]삼성닷컴 개발(회원,배송카트리지 API 개발 )
- [19.07 ~ 19.12][BackEnd]서울 시청 음성 인식 회의록 웹 플랫폼 개발
